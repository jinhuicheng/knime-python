 ...
 */
public class BytesCollectionColumn implements Column {

    BytesColumn[] m_values;

    /**
     * Constructor.
     * @param capacity  the number of values that can be stored
     */
    public BytesCollectionColumn(final int capacity) {
        m_values = new BytesColumn[capacity];
    }
     ...
     */
    public void set(final int index, final BytesColumn value) {
     ...
     * @return the value
     */
    public BytesColumn get(final int index) {
