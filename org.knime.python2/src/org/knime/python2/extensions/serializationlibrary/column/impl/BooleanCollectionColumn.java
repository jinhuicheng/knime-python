 ...
 */
public class BooleanCollectionColumn implements Column {

    BooleanColumn[] m_values;

    /**
     * Constructor.
     * @param capacity  the number of values that can be stored
     */
    public BooleanCollectionColumn(final int capacity) {
        m_values = new BooleanColumn[capacity];
    }
     ...
     */
    public void set(final int index, final BooleanColumn value) {
     ...
     * @return the value
     */
    public BooleanColumn get(final int index) {
