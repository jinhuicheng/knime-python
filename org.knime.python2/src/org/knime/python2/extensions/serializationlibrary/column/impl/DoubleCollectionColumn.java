 ...
 */
public class DoubleCollectionColumn implements Column {

    DoubleColumn[] m_values;

    /**
     * Constructor.
     * @param capacity  the number of values that can be stored
     */
    public DoubleCollectionColumn(final int capacity) {
        m_values = new DoubleColumn[capacity];
    }
     ...
     */
    public void set(final int index, final DoubleColumn value) {
     ...
     * @return the value
     */
    public DoubleColumn get(final int index) {
