 ...
 */
public class IntCollectionColumn implements Column {
     ...
     */
    public IntCollectionColumn(final int capacity) {
        m_values = new IntColumn[capacity];
    }
     ...
     */
    public void set(final int index, final IntColumn value) {
     ...
     * @return the value
     */
    public IntColumn get(final int index) {
