 ...
 */
public class StringCollectionColumn implements Column {

    StringColumn[] m_values;

    /**
     * Constructor.
     * @param capacity  the number of values that can be stored
     */
    public StringCollectionColumn(final int capacity) {
        m_values = new StringColumn[capacity];
    }
     ...
     */
    public void set(final int index, final StringColumn value) {
     ...
     * @return the value
     */
    public StringColumn get(final int index) {
