 ...
 */
public class LongCollectionColumn implements Column {
     ...
     */
    public LongCollectionColumn(final int capacity) {
        m_values = new LongColumn[capacity];
    }
     ...
     */
    public void set(final int index, final LongColumn value) {
     ...
     * @return the value
     */
    public LongColumn get(final int index) {
