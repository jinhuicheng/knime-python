...
/**
 * Used as an abstraction for a table offering rowwise as well as columnwise iterators.
 *
...
public interface TableRep {
    ...
    /**
     * @return a rowwise iterator over the enclosing table.
     */
    public TableIterator getRowIterator();

    /**
     *
     * @return a columnwise iterator over the enclosing table.
     */
