...
/**
 * Class for managing a Table containing a single row of values.
 *
 * @author Clemens von Schwerin, KNIME GmbH, Konstanz, Germany
 */
public class KeyValueTableRep implements TableRep {

    final TableSpec m_spec;
    final Row       m_row;
     ...
     */
    public KeyValueTableRep(final TableSpec spec, final Row row) {
        m_spec = spec;
        m_row = row;
    }
    /**
    ...
    public TableIterator getRowIterator() {
       return new KeyValueTableIterator(m_spec, m_row);
    }
    ...
    public TableColumnIterator getColumnIterator() {
        return new KeyValueColumnIterator(m_spec, m_row);
    }
